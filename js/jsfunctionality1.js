...
/* Funktionen öppnar menyn när den är stängd, och stänger den när den är öppen */
function toggleMenu() {
    if (navigationList.style.display == "block") {
        navigationList.style.display = "none";
    } else { navigationList.style.display = "block"; }
}
